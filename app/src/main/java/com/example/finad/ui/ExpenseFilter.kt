                ...
                Column(Modifier.padding(16.dp)) {
                    ...
                    Button(
                            onClick = {
                                ...
                                navController.popBackStack("expense/list", inclusive = false)
                            },
                            modifier = Modifier.fillMaxWidth(),
                            colors =
                    ...
                    OutlinedButton(
                            onClick = { expenseViewModel.updateFilters(ListExpenseFilterDto()) },
                            modifier = Modifier.fillMaxWidth().padding(top = 8.dp)
                    ) {
                        Icon(Icons.Default.Notifications, contentDescription = "Resetar")
                        Spacer(Modifier.width(8.dp))
